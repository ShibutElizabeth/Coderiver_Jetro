        ...
        <div class="about page-container__main">
            ...
            <?php if($post_paragraph){
                if($post_media){
                    if($post_pos == 1){
            ?>
            <div class="paragraphs float-left">
                <img class="about__img float-right margin-left_about" src="<?php echo $post_media['guid'] ?>" />
                <?php echo $post_paragraph ?>
            </div>
            <?php } 
                    else { ?>
            <div class="paragraphs float-right">
                <img class="about__img float-left margin-right_about" src="<?php echo $post_media['guid'] ?>" />
                <?php echo $post_paragraph ?>
            </div>
            ...
            <div class="paragraphs flex-layout flex-layout--nowrap">
                <div class="float-right">
                    <svg class="about__svg float-left margin-right_about" xmlns="http://www.w3.org/2000/svg"
            ...
            <?php }
                ...
                <div class="paragraphs about__quote flex-layout flex-layout--nowrap">
                    <div class="about__quote-stripe float-left margin-right_about"></div>
                    <i class="about__quote-text maintext float-right">
                        <?php echo $post_quote?>
                    </i>
                </div>
                <!-- END about__quote -->
            ...
            <?php } 
                ...
                <div class="paragraphs block flex-layout flex-layout--nowrap">
                    ...
                    <?php if($post_col2 && !$post_col3){   ?>
                        <div class="float-left margin-right_about"><?php echo $post_col1 ?></div>
                        <div class="float-right"><?php echo $post_col2 ?></div>
                    <?php }
                    else if($post_col2 && $post_col3){ ?>
                        <div class="about__p"><?php echo $post_col1 ?></div>
                        <div class="about__p"><?php echo $post_col2 ?></div>
                        <div class="about__p"><?php echo $post_col3 ?></div>
