<?php get_header(); ?>
<div class="container aligncenter margin-top">
    <div class="slider">
    ...
    <div class="posts flex-layout">
        <div class="post">
            ...
            <p class="post__description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius dolor,
        ...
        <div class="post">
            ...
            <p class="post__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora debitis
        ...
        <div class="post">
            ...
            <p class="post__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt qui sunt,
        ...
        <div class="recent">
            <div class="flex-layout side__titleblock">
                <p class="font-title post__title recent__title side__title">RECENT WORKS</p>
